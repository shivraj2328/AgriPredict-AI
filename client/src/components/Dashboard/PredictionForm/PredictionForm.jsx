...
function PredictionForm({ formData, setFormData, handlePredict, handleReset }) {
    ...
    return (
        <div className="card prediction-form shadow p-4">
            <h4 className="mb-4">Soil Parameters</h4>
            ...
            <div className="row px-2">
                <FarmLocation onLocationSelect={handleLocationSelect} />
            </div>
